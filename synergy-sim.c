...
JNIEXPORT void JNICALL Java_com_adp_clocks_synergy2416_demo_FPU_REDON(JNIEnv * env, jclass class){
	printf("Red LED ON\n");
}

JNIEXPORT void JNICALL Java_com_adp_clocks_synergy2416_demo_FPU_REDOFF(JNIEnv * env, jclass class){
	printf("Red LED OFF\n");
}

JNIEXPORT void JNICALL Java_com_adp_clocks_synergy2416_demo_FPU_GREENON(JNIEnv * env, jclass class){
	printf("Green LED ON\n");
}

JNIEXPORT void JNICALL Java_com_adp_clocks_synergy2416_demo_FPU_GREENOFF(JNIEnv * env, jclass class){
	printf("Green LED OFF\n");
}

JNIEXPORT jint JNICALL Java_com_adp_clocks_synergy2416_demo_FPU_FP_1OPENDEVICE
...
JNIEXPORT jint JNICALL Java_com_adp_clocks_synergy2416_demo_FPU_FP_1CLOSEDEVICE
...
JNIEXPORT jint JNICALL Java_com_adp_clocks_synergy2416_demo_FPU_FP_1ENROLE_1EMPLOYEE
...
JNIEXPORT jint JNICALL Java_com_adp_clocks_synergy2416_demo_FPU_FP_1VALIDATE_1EMPLOYEE
...
JNIEXPORT jint JNICALL Java_com_adp_clocks_synergy2416_demo_FPU_FP_1DELETE_1TEMPLATE(JNIEnv *env, jclass jcls,jstring badge, jint fingerNum ){
	const char *nativeBadge =(*env)->GetStringUTFChars(env, badge, 0);
	static char fileName[35];
	long badgeL = atol(nativeBadge);
...
JNIEXPORT jobjectArray JNICALL Java_com_adp_clocks_synergy2416_demo_FPU_FP_1GET_1BADGES(JNIEnv *env, jclass jcls){
	int i=0;
...
JNIEXPORT jint JNICALL Java_com_adp_clocks_synergy2416_demo_FPU_FP_1GET_1BADGE_1STATUS(JNIEnv *env, jclass jcls,jstring badge, jint fingernum ){
	const char *nativeBadge =(*env)->GetStringUTFChars(env, badge, 0);
	long badgeL = atol(nativeBadge);
	long fingerNumber = (long)fingernum;
	int nRet = 0;
...
JNIEXPORT jint JNICALL Java_com_adp_clocks_synergy2416_demo_FPU_FP_1SET_1TEMPLATE(JNIEnv *env, jclass jcls,jstring badge, jint fingernum, jstring template ){
...
JNIEXPORT jstring JNICALL Java_com_adp_clocks_synergy2416_demo_FPU_FP_1GET_1TEMPLATE(JNIEnv *env, jclass jcls,jstring badge, jint fingernum ){
	const char *nativeBadge =(*env)->GetStringUTFChars(env, badge, 0);
	long badgeL = atol(nativeBadge);
	long fingerNum = (long)fingernum;
...
JNIEXPORT jint JNICALL Java_com_adp_clocks_synergy2416_demo_FPU_FP_1GET_1ENROLECOUNT(JNIEnv *env, jclass jcls){
	return (int)hlpGetEnrollCount();
}

JNIEXPORT jint JNICALL Java_com_adp_clocks_synergy2416_demo_FPU_FP_1IDENTIFY_1EMPLOYEE(JNIEnv *env,jclass jcls){
	int nRet;
